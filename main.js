...
import myBoat from "./Physics2";
// import { log } from "three/webgpu";
import Boat from "./Physics2";

// Create Physics2 object
// var myBoat = new Boat();
...
////2222 ربط الفزيا مع الرسم
physic.update();

  models[0].position.x=boatModel.position.x;
  models[0].position.y=boatModel.position.y;
  models[0].position.z=boatModel.position.z;
